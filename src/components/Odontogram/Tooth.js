...
function Tooth({ number, positionX, positionY, onChange, initialToothState }) {
    const initialState = {
        Cavities: {
            center: 0,
            top: 0,
        ...
        Filter: 0,
        Fracture: 0,
        ...initialToothState // Merging initial state
    };
    ...
    // Efek untuk mengatur state awal dan panggil onChange
    useEffect(() => {
        if (firstUpdate.current) {
            onChange(number, initialToothState);
    ...
    function setCavities(prevState, zone, value) {
        ...
        if (zone === "all") {
            newCavities.center = value;
            newCavities.top = value;
            newCavities.bottom = value;
            newCavities.left = value;
            newCavities.right = value;
        } else {
